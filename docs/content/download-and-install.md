...
Latest **v2.43.0** release `2026-06-10` ([changelog](https://github.com/static-web-server/static-web-server/releases/tag/v2.43.0), [sha256sum](https://github.com/static-web-server/static-web-server/releases/download/v2.43.0/static-web-server-v2.43.0-SHA256SUM))
